                            ...
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    ...
                                    <h5 class="mb-0 fw-700 text-center mt-3">
                                        <?php echo $dat['name']; ?>
                                        <small class="text-muted mb-0"><?php echo $dat['workplace']; ?></small>
                                    </h5>
                            ...
                            <div class="col-12">
                                <div class="p-3 text-center">
                                    <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $dat['number']; ?></a>
                                    <a href="mailto:oliver.kopyov@marlin.ru" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?php echo $dat['email']; ?></a>
                                    <address class="fs-sm fw-400 mt-4 text-muted">
                                        <i class="fas fa-map-pin mr-2"></i> <?php echo $dat['address']; ?>
                                    </address>
                                </div>
                            </div>
                        </div>
